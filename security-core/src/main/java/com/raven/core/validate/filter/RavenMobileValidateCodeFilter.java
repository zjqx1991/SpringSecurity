...
//@Component
@Setter
public class RavenMobileValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        this.validateUrlSet.add("/authentication/mobile");
    }
    ...
    private void validate(ServletWebRequest request) throws ServletRequestBindingException {
        ...
        RavenValidateCode mobileCode = (RavenValidateCode) this.sessionStrategy.getAttribute(request, RavenSecurityConstants.SESSION_KEY_PREFIX + "SMS");
        ...
        if (mobileCode.isExpried()) {
            this.sessionStrategy.removeAttribute(request, RavenSecurityConstants.SESSION_KEY_PREFIX + "SMS");
            throw new RavenValidateCodeException("验证码已过期");
        }

        if (!StringUtils.equals(mobileCode.getCode(), codeInRequest)) {
