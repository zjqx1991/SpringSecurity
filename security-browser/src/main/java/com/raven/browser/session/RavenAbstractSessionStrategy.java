 ...
 */
@Slf4j
public class RavenAbstractSessionStrategy {
	 ...
	 * 系统配置信息
	 */
	private RavenSecurityProperties securityPropertie;
	/**
	 * 重定向策略
	 */
	 ...
	 */
	public RavenAbstractSessionStrategy(RavenSecurityProperties securityPropertie) {
	...
	protected void onSessionInvalid(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (StringUtils.endsWithIgnoreCase(sourceUrl, ".html")) {
			if(StringUtils.equals(sourceUrl, this.securityPropertie.getBrowser().getSignInPage())
					|| StringUtils.equals(sourceUrl, this.securityPropertie.getBrowser().getSignOutUrl())){
				targetUrl = sourceUrl;
			}else{
